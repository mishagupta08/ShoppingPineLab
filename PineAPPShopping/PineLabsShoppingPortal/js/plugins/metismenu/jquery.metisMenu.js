...
!function (a) {
    ...
    function c(b) {
        return this.each(function () {
            ...
            d = c.data('mm'),
            f = a.extend({
            }, e.DEFAULTS, c.data(), 'object' == typeof b && b);
    ...
    e.prototype.init = function () {
        ...
        this.$element.find('li').has('ul').children('a').on('click.metisMenu', function (d) {
            ...
            b.options.doubleTapToGo && b.doubleTapToGo(e) && '#' !== e.attr('href') && '' !== e.attr('href') ? (d.stopPropagation(), void (document.location = e.attr('href'))) : void 0
        })
    },
