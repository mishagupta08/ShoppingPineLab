...
namespace PineAPPService.Models
{
    ...
    public partial class LivePineLabsEntities : DbContext
    {
        public LivePineLabsEntities()
            : base("name=LivePineLabsEntities")
        {
        }
        ...
        public virtual ObjectResult<getBillAddress_Result> getBillAddress(string userid, string refno)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<getBillAddress_Result>("getBillAddress", useridParameter, refnoParameter);
        }
        ...
        public virtual int sp_BulkEmailDataInsert(string regXML)
        {
            var regXMLParameter = regXML != null ?
                new ObjectParameter("regXML", regXML) :
                new ObjectParameter("regXML", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_BulkEmailDataInsert", regXMLParameter);
        }
    
        public virtual int sp_BulkSMSDataInsert(string regXML)
        {
            var regXMLParameter = regXML != null ?
                new ObjectParameter("regXML", regXML) :
                new ObjectParameter("regXML", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_BulkSMSDataInsert", regXMLParameter);
        }
